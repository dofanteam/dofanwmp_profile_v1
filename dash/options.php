...
function optionsframework_options() {
   ...
   // 用户QQ群
    $options[] = array(
        'name' => __( '用户QQ群', 'tt' ),
        'desc' => sprintf(__( '<br><h2><a href="%s" target="_blank">Tint主题用户/WordPress交流群：207629671</a></h2>', 'tt'), 'https://jq.qq.com/?_wv=1027&k=5Dk66jL'),
        'type' => 'info'
    );
...
$options[] = array(
  ...
  $options[] = array(
        ...
        'desc' => __( '启用右侧返回顶部浮动工具栏额外按钮（可在Tint/core/modules/mod.FixedControls.php中添加更多功能）', 'tt' ),
        'id' => 'tt_enable_k_fdgj',
        'std' => true,
        'type' => 'checkbox'
    );
